<template>
  <div class="app-body">
    <div class="body-block">
      ...
      <div :class="[(orderInfo.ollage_pay_type == 2 && orderInfo.order_status == 0) || orderInfo.is_logistice_btn ? 'scroll-body-btn' : '', 'order-session scroll-body']">
          ...
          <div class="collage-user flex-align-center">
            <template v-if="userList.length < 7">
              <div v-for="(item, index) in userList" class="collage-user-info">
                <img v-if="item.avatar" class="collage-user-photo" :src="item.avatar" />
