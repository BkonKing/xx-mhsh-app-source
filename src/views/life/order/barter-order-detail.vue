<template>
  <div class="app-body">
    ...
    <div class="order-session">
      ...
      <div class="cont-session goods-session">
        ...
        <div class="order-total order-total-detail">
          <div class="color-8f8f94 font-24">
            共 {{ infoData.barter_num }} 件
          </div>
        </div>
      </div>
      <div
        v-if="infoData.order_status != 6"
        class="cont-session address-logistics"
      >
        ...
        <div v-if="mail_logistice_info" class="shipping-logistics">
          <div
            @click="linkFunc(22, { id: mail_logistice_info.id })"
            v-if="
              mail_logistice_info.s_time && mail_logistice_info.s_time != '0'
            "
          ...
          >
            ...
            <div class="color-222 font-28 order-tip-text">
              {{ mail_logistice_info.kuaidi_name }}
            </div>
            ...
            >
              ...
              <div class="shipping-address-item-right">
                ...
                <div class="color-8f8f94 font-28">
                  ({{ mail_logistice_info.kuaidi_numb }})
                </div>
                <img
            ...
            >
              ...
              >
                ...
                <div class="shipping-logistics-text">
                  {{ mail_logistice_info.kd_text_arr.data[0].context }}<br />{{
                    mail_logistice_info.kd_text_arr.data[0].time
                  }}
                </div>
              </div>
            </div>
      ...
      <div
        v-if="infoData.order_status == 0 || infoData.order_status == 1"
        class="cont-session order-message"
      >
        <template>
          <div class="order-tip-item">
            ...
            <div class="order-tip-item-right color-222 font-28 order-tip-text">
              {{ infoData.reason_text ? infoData.reason_text : "无" }}
            </div>
          </div>
        ...
        <div class="shipping-address">
          <div class="shipping-address-item">
            ...
            <div
              ...
              @click="
                copy_cont(
                  infoData.return_name + infoData.return_tel + infoData.tuihuo2
                )
              "
            >
      ...
      <div v-else class="cont-session order-message">
        <template>
          <div class="order-tip-item">
            ...
            <div
              class="order-tip-item-right color-8f8f94 font-28 order-tip-text"
            >
              {{ infoData.reason_text ? infoData.reason_text : "无" }}
            </div>
          </div>
        ...
        <template v-if="go_logistice_info">
          <div
            ...
            v-if="go_logistice_info.s_time && go_logistice_info.s_time != '0'"
            class="order-tip-item"
          >
            <div class="order-tip-item-left order-tip-text color-222 font-28">
              退货物流:
          ...
          >
            ...
            <div class="shipping-logistics-item">
              ...
              >
                ...
                <div class="shipping-logistics-line"></div>
                <div class="shipping-logistics-text">
                  {{ go_logistice_info.kd_text_arr.data[0].context }}<br />{{
                    go_logistice_info.kd_text_arr.data[0].time
                  }}
                </div>
              </div>
            </div>
    ...
    <template v-if="infoData.order_status == 0 || infoData.order_status == 1">
      ...
      <div class="btn-fixed-buttom">
        <div
          v-if="infoData.order_status == 0"
          class="order-border-btn"
          hover-class="none"
        >
          <div @click="cancelApply" class="color-8f8f94 font-28">取消换货</div>
        </div>
        <div
          v-else-if="infoData.order_status == 1"
          class="order-border-btn paid-btn"
        >
          <div @click="linkFunc(19)" class="color-fff font-26">
            填写寄出物流
          </div>
        </div>
      </div>
