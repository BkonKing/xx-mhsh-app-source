  ...
  <div class="header-bg">
    ...
    >
      <div class="dialog-content">
        ...
        <div class="tf-text-sm tf-mt-lg">提示：请勿随意点击或给陌生人开门，否则追究法律责任。具体查看协议<router-link class="tf-text-blue" to="/agreement?articleType=2">《{{otherAgreement.title}}》</router-link>。</div>
      </div>
    </tf-dialog>
  </div>
</template>
